...
│                                                                                         │
│   ┌──────────────────┐                              ┌──────────────────────────┐       │
│   │    Angular 18    │        HTTP/REST             │     Spring Boot 3.2      │       │
│   │    Web App       │ ◄──────────────────────────► │      Backend API         │       │
│   │   (Thérapeute)   │       (JSON + JWT)           │      Port: 8080          │       │
│   │   Port: 4200     │                              │                          │       │
│   └──────────────────┘                              └────────────┬─────────────┘       │
│                                                                   │                     │
│   ┌──────────────────┐        HTTP/REST                          │ HTTP/REST           │
...
│   │   │   └── pages/
│   │   │       ├── login_page.dart
│   │   │       ├── register_patient_page.dart
│   │   │       └── select_therapeute_page.dart
│   │   └── data/
│   │
│   ├── home/                 # Accueil patient
│   │   └── presentation/
│   │       └── pages/home_page.dart
│   │
│   ├── appointments/         # Mes séances
│   │   ├── presentation/
│   │   │   ├── bloc/seance_bloc.dart
│   │   │   └── pages/appointments_page.dart
│   │   └── data/models/seance_model.dart
│   │
...
│
└── main.dart                 # Point d'entrée + Router
```

### Fonctionnalités Mobile

- ✅ Authentification (login/register avec choix du thérapeute)
- ✅ Tableau de bord patient
- ✅ Visualisation des séances (calendrier + liste)
- ✅ Demande de nouvelles séances (avec approbation thérapeute)
- ✅ Affichage des prédictions ML avec recommandations personnalisées
- ✅ Graphique d'évolution du risque
- ✅ Détails de séance (notes, thérapeute, durée)
- ✅ Profil patient

### Technologies Mobile

- **Flutter 3.x** - Framework Dart cross-platform
- **flutter_bloc** - Gestion d'état (BLoC pattern)
- **Dio** - Client HTTP pour API REST
- **go_router** - Navigation déclarative
- **shared_preferences** - Stockage local
- **intl** - Formatage dates (français)
...
|---------|-----|-------------|
| **Frontend Web** | http://localhost:4200 | Interface Angular (Thérapeute) |
| **Mobile App** | http://localhost:4201 | App Flutter (Patient) |
